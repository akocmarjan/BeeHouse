...
<body>
    ...
    <main>
        <section class="account">
            ...
            <form action="include/signin-tenant-inc.php" class="form" method="post">
                <div class="form-step form-step-active w3-animate-fading w3-animate-opacity">
                    <h1>Sign in to start looking for property</h1>
                    ...
                    <div class="">
                        <a href="signup-tenant.php" class="btn btn-signin width-50 ml-auto"><span>Create your tenant account</span></a>
                    </div>
                </div>
                <div class=foot>
                    <hr class="line">
