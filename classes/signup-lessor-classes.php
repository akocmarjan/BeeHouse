...
class Signup extends Dbh{
    ...
    protected function setUser($username, $email, $firstname, $lastname, $phone, $hashed_password){
        $result = $this->connect()->prepare("INSERT INTO lessor (username, email, first_name, last_name, phone, password) VALUES (?,?,?,?,?,?);");
    ...
    protected function checkUser($username, $email){
        $result = $this->connect()->prepare("SELECT username FROM lessor WHERE username = ? OR email = ?;");
